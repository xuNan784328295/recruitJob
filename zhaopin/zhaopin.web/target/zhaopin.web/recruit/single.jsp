				...
				<div class="container">
					<div class="row d-flex align-items-center justify-content-center">
						<div class="about-content col-lg-12">
							...
							<p class="text-white link-nav"><a href="index.html">Home </a>  <span class="lnr lnr-arrow-right"></span>  <a href="single.jsp"> Job Details</a></p>
						</div>											
					</div>
				</div>
			</section>
							...
							<div class="single-slidebar">
								...
								<div class="active-relatedjob-carusel">
									<div class="single-rated">
										...
										<a href="single.jsp"><h4>Creative Art Designer</h4></a>
										<h6>Premium Labels Limited</h6>
										<p>
											Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod temporinc ididunt ut dolore magna aliqua.
										</p>
							...
							<div class="single-slidebar">
								...
								<div class="blog-list">
									<div class="single-blog " style="background:#000 url(img/blog1.jpg);">
										<a href="single.jsp"><h4>Home Audio Recording <br>
										For Everyone</h4></a>
